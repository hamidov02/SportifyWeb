                ...
                <div className="row justify-content-center ">             
                    <div className="col-4 offset-1 col-sm-2">
                        ...
                        <ul className="list-unstyled">
                            <li><Link className="footer_l" to='/home'>Home</Link></li>
                            <li><Link className="footer_l" to='/aboutus'>About Us</Link></li>
                            <li><Link className="footer_l" to='/contactus'>Contact Us</Link></li>
                        </ul>
                    </div>
